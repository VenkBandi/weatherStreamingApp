...
def weatherStreamingApp(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = "ehw-weather-streaming.servicebus.windows.net"
    ...
    #function to send events to Events Hub
    ...
    def fetch_weather_data():
        ...
        location = "Helsinki"  # You can replace with any city name based on your preference
        vault_url = "https://kvw-weather-streaming.vault.azure.net/"
        secret_name = "weatherapikey"
        weatherapikey = get_secret_from_keyvault(vault_url,secret_name)
        # Get data from API
